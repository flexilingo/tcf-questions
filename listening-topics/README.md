...
| --- | --- | --- | --- | --- | --- |
| 1 | Un article analysant les particularités du roman historique comme genre littéraire. | An article analyzing the features of historical novels. | 2 sources | 2026-09 | - |
| 2 | Un atelier de cuisine où sont enseignées diverses techniques culinaires. | A cooking workshop teaching culinary techniques. | 1 source | 2026-09 | - |
| 3 | Un document audio concernant un événement communautaire de quartier. | An audio document about a neighborhood community event. | 1 source | 2026-09 | - |
| 4 | Un document audio présentant plusieurs événements culturels. | An audio document presenting cultural events. | 1 source | 2026-09 | - |
| 5 | Un document audio traitant du cinéma européen. | An audio document about European cinema. | 1 source | 2026-09 | - |
...
| # | Topic (French) | In English | Reported by | First seen | Analysis |
| --- | --- | --- | --- | --- | --- |
| 1 | Un appel téléphonique au service client au sujet d'un appareil défectueux. | A phone call to customer service about a faulty device. | 1 source | 2026-09 | - |
...
| # | Topic (French) | In English | Reported by | First seen | Analysis |
| --- | --- | --- | --- | --- | --- |
| 1 | Un conseil radiophonique sur la manière de reprendre ou d'adapter une activité physique. | Advice on resuming or adapting physical exercise. | 1 source | 2026-09 | - |
| 2 | Un document décrivant les symptômes d'une maladie. | A document about the symptoms of an illness. | 1 source | 2026-09 | - |
...
| # | Topic (French) | In English | Reported by | First seen | Analysis |
| --- | --- | --- | --- | --- | --- |
| 1 | Un reportage traitant de la crise du logement qui touche particulièrement les jeunes. | A report about the housing crisis affecting young people. | 2 sources | 2026-09 | - |
| 2 | Un dialogue enregistré se déroulant à un accueil. | A recorded dialogue at a reception desk. | 1 source | 2026-09 | - |
| 3 | Un document audio concernant l'inscription à un cours. | An audio document about enrolling in a course. | 1 source | 2026-09 | - |
| 4 | Un document audio concernant un projet de déménagement. | An audio document about a moving project. | 1 source | 2026-09 | - |
| 5 | Un document audio consacré aux médecines non conventionnelles. | An audio document about alternative medicine. | 1 source | 2026-09 | - |
| 6 | Un document audio consacré à la qualité du café. | An audio document about coffee quality. | 1 source | 2026-09 | - |
| 7 | Un document audio portant sur le comportement à adopter au restaurant. | An audio document about restaurant etiquette. | 1 source | 2026-09 | - |
| 8 | Un document audio proposant différents contenus liés au monde animal. | A document featuring various content about animals. | 1 source | 2026-09 | - |
...
| # | Topic (French) | In English | Reported by | First seen | Analysis |
| --- | --- | --- | --- | --- | --- |
| 1 | Un appel téléphonique au sujet du changement d'un forfait internet. | A phone call about modifying an internet subscription. | 1 source | 2026-09 | - |
